<x-admin-layout>
    ...
    <div class="py-6 px-6">
        ...
        <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-1">Homepage Sections</h3>
                    <p class="text-sm text-gray-500 mb-6">Control which sections are visible on the homepage.</p>

                    <div class="flex items-center justify-between py-3 border-b border-gray-100">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">Projects / Portfolio Carousel</p>
                            <p class="text-xs text-gray-400 mt-0.5">Show the featured projects slider on the homepage.</p>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox"
                                   name="homepage_show_projects"
                                   value="1"
                                   {{ old('homepage_show_projects', $homepageSettings['homepage_show_projects'] ?? '1') ? 'checked' : '' }}
                                   class="sr-only peer">
